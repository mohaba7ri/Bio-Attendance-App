...
final conttroler = Get.put(DeniedVacationController(), permanent: true);

class DeniedVacationView extends GetView<DeniedVacationController> {
  @override
  Widget build(BuildContext context) {
    DeniedVacationController _deniedVacationController = DeniedVacationController();
    return Scaffold(
      appBar: AppBar(
        title: Text('denied_vac'.tr),
        leading: IconButton(
          onPressed: () => Get.back(),
      ...
      body: Container(
        ...
        child: StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
          stream: _deniedVacationController.vacationRequests(),
                        ...
                        : Padding(
                            ...
                            child: Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  GetBuilder<DeniedVacationController>(
